...
const HibridaAccountManagement: React.FC = () => {
  ...
  const fetchEnrollments = async () => {
    try {
      ...
      // Merge data
      const enrichedEnrollments: Enrollment[] = enrollmentData.map((enrollment: any) => ({
        ...enrollment,
        profiles: {
  ...
  const handleReject = async (enrollmentId: string) => {
    try {
      ...
      toast({
        title: "Gagal Menolak",
        description: error.message || "Terjadi kesalahan saat menolak pendaftaran.",
        variant: "destructive"
      });
    }
  };
  ...
  const handleSubmitApproval = async () => {
    if (!selectedEnrollment || !newRole) {
      toast({
        ...
        description: "Silakan pilih role untuk peserta.",
        variant: "destructive"
      });
      return;
    }

    // Auto-assign Admin group for super-admin
    const finalGroup = newRole === 'super-admin' ? 'Admin' : newGroup;

    if (!finalGroup && newRole !== 'reguler') {
      toast({
        title: "Data Tidak Lengkap",
        description: "Silakan pilih kelompok untuk peserta.",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      ...
      toast({
        ...
        description: `Peserta berhasil disetujui sebagai ${newRole} di Grup ${finalGroup || '-'}.`,
        variant: "default"
      });
      ...
      toast({
        ...
        description: error.message || "Terjadi kesalahan saat menyetujui pendaftaran.",
        variant: "destructive"
      });
    }
  };
  ...
  const toggleSelectPending = (id: string) => {
    setSelectedPending(prev => {
      ...
      // Update selectAll flag accordingly
  ...
  const getRoleBadge = (role: string) => {
    ...
    const roleLabels: Record<string, string> = {
      'reguler': 'Reguler',
      'grup-int': 'Grup Intervensi',
      'grup-cont': 'Grup Kontrol',
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Kelola pendaftaran dan peserta program Hibrida Naratif CBT</p>
        </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <Select value={roleFilter} onValueChange={(v)=> setRoleFilter(v as any)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="grup-int">Intervensi HN-CBT</SelectItem>
                  <SelectItem value="grup-cont">Psikoedukasi</SelectItem>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Select value={newRole} onValueChange={setNewRole}>
                ...
                <SelectContent>
                  <SelectItem value="grup-int">Grup Intervensi (HN-CBT)</SelectItem>
                  <SelectItem value="grup-cont">Grup Kontrol (Psikoedukasi)</SelectItem>
