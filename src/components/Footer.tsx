        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-lg">Mind MHIRC</span>
            </div>
            <p className="text-muted-foreground text-sm">
              Berfokus pada riset, inovasi, dan intervensi peka budaya dalam kesehatan mental.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/tests" className="text-muted-foreground hover:text-primary transition-colors text-sm">
                  Tes Mental
                </Link>
              </li>
              <li>
