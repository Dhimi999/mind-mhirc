...
export const sessionConfigs = [
  ...
  { key: "hopes", label: "Harapan saya setelah mengikuti layanan ini adalah", desc: "Tuliskan harapan Anda mengikuti layanan ini.", type: "textarea" },
  ...
  { key: "reason_no_commit", label: "Jika memilih Tidak, jelaskan alasannya", desc: "Alasan tidak berkomitmen mengikuti seluruh sesi.", type: "textarea", showIf: { key: "commit_all", equals: false } },
    ],
  ...
  },
  {
    ...
    assignmentFields: [
      { key: "pengertian", label: "Pengertian", desc: "Jelaskan pengertian bunuh diri menurut Anda.", type: "textarea" },
      { key: "risiko", label: "Risiko", desc: "Sebutkan faktor risiko yang Anda ketahui.", type: "textarea" },
      { key: "protektif", label: "Faktor Protektif", desc: "Apa saja faktor protektif yang dapat mencegah bunuh diri?", type: "textarea" },
      { key: "bantuan", label: "Bantuan", desc: "Kemana Anda akan mencari bantuan jika mengalami krisis?", type: "textarea" },
      { key: "hasil", label: "Hasil", desc: "Apa hasil refleksi Anda setelah mempelajari materi ini?", type: "textarea" },
      { key: "refleksi", label: "Refleksi", desc: "Tuliskan refleksi pribadi Anda.", type: "textarea" },
      { key: "jurnal", label: "Jurnal", desc: "Catatan harian terkait topik ini.", type: "textarea" },
    ],
...

  {
    ...
    assignmentFields: [
      { key: "situasi", label: "Situasi", desc: "Ceritakan situasi pemicu yang Anda alami atau amati.", type: "textarea" },
      { key: "tanda", label: "Tanda", desc: "Tuliskan tanda-tanda dini yang Anda kenali.", type: "textarea" },
      { key: "tindakan", label: "Tindakan", desc: "Apa tindakan preventif/support yang dilakukan?", type: "textarea" },
      { key: "hasil", label: "Hasil", desc: "Bagaimana hasil dari tindakan tersebut?", type: "textarea" },
      { key: "refleksi", label: "Refleksi", desc: "Refleksi pribadi Anda setelah sesi ini.", type: "textarea" },
      { key: "jurnal", label: "Jurnal", desc: "Catatan harian terkait perkembangan emosi & pikiran.", type: "textarea" },
    ],
...

  {
    ...
    assignmentFields: [
      { key: "situasi", label: "Situasi", desc: "Identifikasi situasi pemicu stres yang Anda alami.", type: "textarea" },
      { key: "kopingMaladaptif", label: "Koping Maladaptif", desc: "Tuliskan koping maladaptif (menghindar, menarik diri, dll) yang selama ini Anda lakukan.", type: "textarea" },
      { key: "perencanaanAktivitas", label: "Perencanaan Aktivitas", desc: "Rencanakan aktivitas adaptif terstruktur yang bisa Anda lakukan.", type: "textarea" },
      { key: "tindakan", label: "Tindakan", desc: "Tindakan konkret yang sudah/akan Anda lakukan.", type: "textarea" },
      { key: "hasil", label: "Hasil", desc: "Evaluasi hasil dari tindakan tersebut.", type: "textarea" },
      { key: "refleksi", label: "Refleksi", desc: "Refleksi pribadi Anda.", type: "textarea" },
      { key: "jurnal", label: "Jurnal", desc: "Catatan harian untuk konsistensi.", type: "textarea" },
    ],
...

  {
    ...
    assignmentFields: [
      { key: "situasi", label: "Situasi", desc: "Identifikasi situasi pemicu kebutuhan bantuan.", type: "textarea" },
      { key: "perilakuMencariBantuan", label: "Perilaku Mencari Bantuan", desc: "Definisikan perilaku mencari bantuan adaptif yang bisa Anda lakukan.", type: "textarea" },
      { key: "tindakan", label: "Tindakan", desc: "Jabarkan langkah tindakan konkret.", type: "textarea" },
      { key: "hasil", label: "Hasil", desc: "Evaluasi hasil & hambatan yang dialami.", type: "textarea" },
      { key: "refleksi", label: "Refleksi", desc: "Refleksi motivasi & rencana tindak lanjut.", type: "textarea" },
      { key: "jurnal", label: "Jurnal", desc: "Catatan harian terkait proses mencari bantuan.", type: "textarea" },
    ],
...

  {
    ...
    assignmentFields: [
      { key: "situasi", label: "Situasi", desc: "Identifikasi situasi dimana stigma muncul.", type: "textarea" },
      { key: "dampakStigma", label: "Dampak Stigma", desc: "Tuliskan dampak stigma pada pikiran, emosi, dan perilaku Anda.", type: "textarea" },
      { key: "upayaMengurangiStigma", label: "Upaya Mengurangi Stigma", desc: "Tuliskan 2-3 langkah konkret untuk mengurangi stigma di lingkungan Anda.", type: "textarea" },
      { key: "hasil", label: "Hasil", desc: "Evaluasi hasil upaya yang dilakukan.", type: "textarea" },
      { key: "refleksi", label: "Refleksi", desc: "Refleksi pribadi Anda.", type: "textarea" },
      { key: "jurnal", label: "Jurnal", desc: "Catatan harian terkait perubahan persepsi.", type: "textarea" },
    ],
...

  {
    ...
    assignmentFields: [
      { key: "situasi", label: "Situasi", desc: "Identifikasi situasi Anda yang membutuhkan dukungan.", type: "textarea" },
      { key: "macamDukunganSosial", label: "Macam Dukungan Sosial", desc: "Pilah macam dukungan: emosional, informasional, instrumental, dan penilaian.", type: "textarea" },
      { key: "sumberDukunganSosial", label: "Sumber Dukungan Sosial", desc: "Daftar sumber dukungan nyata yang bisa segera dihubungi.", type: "textarea" },
      { key: "hasil", label: "Hasil", desc: "Evaluasi hasil dari dukungan yang diterima.", type: "textarea" },
      { key: "refleksi", label: "Refleksi", desc: "Refleksi pribadi Anda.", type: "textarea" },
      { key: "jurnal", label: "Jurnal", desc: "Catatan harian terkait jaringan dukungan.", type: "textarea" },
    ],
...

  {
    ...
    assignmentFields: [
      { key: "situasi", label: "Situasi", desc: "Identifikasi kebutuhan dan situasi yang memerlukan informasi sumber daya.", type: "textarea" },
      { key: "penyediaanInformasiSumberDaya", label: "Penyediaan Informasi Sumber Daya", desc: "Susun daftar kontak penting: nomor darurat, layanan kampus, organisasi komunitas, dan tautan tepercaya.", type: "textarea" },
      { key: "hasil", label: "Hasil", desc: "Evaluasi hasil penggunaan informasi: apakah akses terbantu dan apa tindak lanjutnya.", type: "textarea" },
      { key: "refleksi", label: "Refleksi", desc: "Refleksi pribadi Anda.", type: "textarea" },
      { key: "jurnal", label: "Jurnal", desc: "Catatan harian terkait akses sumber daya.", type: "textarea" },
    ],
...

  {
    ...
    assignmentFields: [
      { key: "situasi", label: "Situasi", desc: "Identifikasi situasi atau konteks keseluruhan program.", type: "textarea" },
      { key: "faktorRisikoBunuhDiri", label: "Faktor Risiko Bunuh Diri", desc: "Tuliskan pemahaman Anda tentang faktor risiko bunuh diri.", type: "textarea" },
      { key: "faktorProtektifRisikoBunuhDiri", label: "Faktor Protektif Risiko Bunuh Diri", desc: "Tuliskan pemahaman Anda tentang faktor protektif.", type: "textarea" },
      { key: "tandaRisikoBunuhDiri", label: "Tanda Risiko Bunuh Diri", desc: "Tuliskan tanda-tanda risiko yang Anda kenali.", type: "textarea" },
      { key: "sumberDukunganSosial", label: "Sumber Dukungan Sosial", desc: "Daftar sumber dukungan yang telah Anda bangun.", type: "textarea" },
      { key: "caraMengurangiStigmaNegatif", label: "Cara Mengurangi Stigma Negatif", desc: "Tuliskan cara mengurangi stigma yang telah Anda pelajari.", type: "textarea" },
      { key: "refleksiPerubahan", label: "Refleksi Perubahan", desc: "Refleksikan perubahan yang Anda rasakan setelah mengikuti program.", type: "textarea" },
      { key: "tantangan", label: "Tantangan", desc: "Tuliskan tantangan yang Anda hadapi selama program.", type: "textarea" },
      { key: "rencanaTindakLanjut", label: "Rencana Tindak Lanjut", desc: "Susun rencana tindak lanjut untuk menjaga keberlanjutan pembelajaran.", type: "textarea" },
      { key: "refleksi", label: "Refleksi", desc: "Refleksi akhir Anda.", type: "textarea" },
      { key: "jurnal", label: "Jurnal", desc: "Catatan harian akhir program.", type: "textarea" },
    ],
...
const SpiritualPsikoedukasiUnified: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!user) {
      navigate('/spiritual-budaya/psikoedukasi/login-required');
      return;
    }
      ...
      if (sessionNumber > 0 && !isSuperAdmin && user?.id) {
        try {
          ...
          if (!data || !(data as any)?.assignmentDone) {
            navigate('/spiritual-budaya/psikoedukasi');
            return;
          }
        } catch (e) {
