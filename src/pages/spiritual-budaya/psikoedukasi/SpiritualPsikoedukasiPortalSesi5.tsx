                    ...
                    <div className="bg-white rounded-sm">
                      ...
                      <CardContent className="p-6">
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                          ...
                          <div className="sm:ml-auto"><Badge className={progress.meetingDone ? 'bg-green-600 text-white' : 'bg-amber-200 text-amber-900'}>{progress.meetingDone ? 'âœ“ Sudah selesai' : 'â³ Belum selesai'}</Badge></div>
                        </div>
                      </CardContent>
                    </div>
                  </div>
