...
const SpiritualPsikoedukasiPortalSesi2: React.FC = () => {
  ...
  const { progress, meetingSchedule: schedule, markMeetingDone, markGuideDone, submitAssignment, loadAssignment, autoSaveAssignment, groupAssignment, isSuperAdmin, allGroupSchedules, loading } = useSpiritualPsikoedukasiSession(sessionNumber, user?.id);
        ...
        <section className="relative overflow-hidden rounded">
          ...
          <div className="relative container mx-auto px-6 py-14">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-amber-100 max-w-2xl">Fokus pada identifikasi tanda-tanda dini & respons adaptif.</p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              <div className="lg:col-span-3 space-y-8">
                ...
                <Card className="border-amber-100 shadow-sm">
                  <CardHeader><CardTitle>Panduan Sesi</CardTitle><CardDescription>Alur pengerjaan sesi ini</CardDescription></CardHeader>
                  <CardContent>
                    {renderGuide()}
                  </CardContent>
                </Card>
                ...
                <Card className="border-amber-100 shadow-sm overflow-hidden">
                  <div className="bg-gradient-to-r from-amber-600 via-orange-600 to-amber-700 p-1"><div className="bg-white rounded-sm">
                ...
                {/* (Panduan Sesi sudah ditampilkan di atas; di sini kita langsung ke Panduan Penugasan) */}
                <Card className="border-amber-100 shadow-sm">
                  <CardHeader><CardTitle>Panduan Penugasan</CardTitle><CardDescription>Rujukan materi & instruksi singkat</CardDescription></CardHeader>
                  <CardContent>
                ...
                <Card className="border-amber-100 shadow-md">
                  ...
                  <CardContent>
                    {!progress.guideDone && !progress.assignmentDone && <div className="mb-4 p-3 rounded border border-amber-300 bg-amber-50 text-amber-900 text-sm">Penugasan terkunci. Selesaikan Panduan Penugasan untuk membuka.</div>}
