...
const ASSIGNMENT_KEY = "spiritualPsikoEduSession3Assignment";

interface AssignmentData {
  situasi: string;
  kopingMaladaptif: string;
  perencanaanAktivitas: string;
  tindakan: string;
  hasil: string;
  refleksi: string;
  jurnal: string;
...
const SpiritualPsikoedukasiPortalSesi3: React.FC = () => {
    ...
    return (
      <div className="space-y-4 text-sm leading-relaxed">
        <div className="rounded-lg border-l-4 border-indigo-600 bg-gradient-to-r from-indigo-50 to-white p-4">
          <p className="font-semibold text-indigo-800 mb-1">Fokus Sesi 3 â€” Koping Adaptif</p>
          <p>Pengembangan keterampilan koping adaptif adalah proses dimana individu dilatih menggunakan strategi sehat menghadapi stres & situasi sulit. Tujuannya mengganti koping maladaptif (menghindar, menarik diri, penggunaan zat) menjadi pola adaptif (problem solving, regulasi emosi, aktivitas bermakna).</p>
        </div>
        <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
          <li>Mengidentifikasi situasi pemicu stres.</li>
          <li>Membedakan koping maladaptif vs adaptif.</li>
          <li>Merencanakan aktivitas adaptif terstruktur.</li>
          <li>Menerapkan & mengevaluasi tindakan.</li>
          <li>Refleksi & jurnal untuk konsistensi.</li>
        </ul>
        <div className="border rounded p-3 bg-indigo-50 text-xs text-indigo-800">Catatan: Jika Anda menggunakan strategi berisiko (misal penyalahgunaan zat), segera pertimbangkan mencari bantuan profesional.</div>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet><title>Sesi 3 - {title} | Psikoedukasi</title><meta name="description" content={`Portal psikoedukasi sesi 3: ${title}`} /><link rel="canonical" href="https://mind-mhirc.my.id/spiritual-budaya/psikoedukasi/sesi/3" /></Helmet>
      <Navbar />
      <main className="flex-1 pt-24">
        <section className="relative overflow-hidden rounded">
          ...
          <div className="relative container mx-auto px-6 py-14"><div className="max-w-5xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-3 text-white drop-shadow-sm">Sesi 3: {title}</h1>
            <p className="text-amber-100 max-w-2xl">Transformasi koping maladaptif menjadi strategi adaptif & konstruktif.</p>
          </div></div>
        </section>
          ...
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              <div className="lg:col-span-1 space-y-6">
                <div className="rounded-xl border border-amber-100 p-4 text-xs leading-relaxed bg-white/60 backdrop-blur"><p className="font-semibold mb-1 text-amber-700">Tips</p><p>Gunakan aktivitas bermakna (olahraga ringan, journaling) sebagai koping adaptif.</p></div>
                <div className="rounded-xl bg-gradient-to-b from-amber-50 to-white border border-amber-100 p-5 shadow-sm sticky top-28">
                  ...
                  <div className="mb-4"><div className="h-3 w-full bg-amber-100 rounded-full overflow-hidden"><div className="h-full bg-gradient-to-r from-amber-600 to-orange-600 rounded-full transition-all" style={{ width: `${overallPercent}%` }} /></div><div className="mt-2 text-xs text-amber-700 font-medium">{overallPercent}% selesai</div></div>
              ...
              <div className="lg:col-span-3 space-y-8">
                {/* Panduan Sesi */}
                <Card className="border-amber-100 shadow-sm"><CardHeader><CardTitle>Panduan Sesi</CardTitle><CardDescription>Alur pengerjaan sesi ini</CardDescription></CardHeader><CardContent>{(() => {
                  if (!progress.meetingDone) return <div className="text-sm text-muted-foreground">Panduan akan muncul setelah Anda menandai Pertemuan Daring selesai.</div>;
                  return (
                    <div className="space-y-4 text-sm leading-relaxed">
                      <div className="rounded-lg border-l-4 border-amber-600 bg-gradient-to-r from-amber-50 to-white p-4">
                        <p className="font-semibold text-amber-800 mb-1">Fokus Sesi 3 — Koping Adaptif</p>
                        <p>Pengembangan keterampilan koping adaptif adalah proses dimana individu dilatih menggunakan strategi sehat menghadapi stres & situasi sulit. Tujuannya mengganti koping maladaptif (menghindar, menarik diri, penggunaan zat) menjadi pola adaptif (problem solving, regulasi emosi, aktivitas bermakna).</p>
                      </div>
                      <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                        <li>Mengidentifikasi situasi pemicu stres.</li>
                      ...
                      <div className="border rounded p-3 bg-amber-50 text-xs text-amber-800">Catatan: Jika Anda menggunakan strategi berisiko (misal penyalahgunaan zat), segera pertimbangkan mencari bantuan profesional.</div>
                ...
                <Card className="border-amber-100 shadow-sm overflow-hidden"><div className="bg-gradient-to-r from-amber-600 via-orange-600 to-amber-700 p-1"><div className="bg-white rounded-sm">
                  <CardHeader className="bg-gradient-to-r from-amber-50 to-orange-50"><div className="flex items-center gap-3"><div className="p-2 bg-amber-600 rounded-lg"><svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg></div><div><CardTitle className="text-amber-800">Informasi Pertemuan Daring</CardTitle><CardDescription>Jadwal dan link pertemuan sesi ini</CardDescription></div></div></CardHeader>
                  <CardContent className="p-6">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                      <div className="flex flex-wrap items-center gap-3">
                        <Button size="sm" className="bg-amber-600 hover:bg-amber-700" disabled={!schedule?.link} onClick={() => schedule?.link && window.open(schedule.link,'_blank')}>Mulai Pertemuan</Button>
                ...
                <Card className="border-amber-100 shadow-md"><CardHeader><CardTitle>Penugasan</CardTitle><CardDescription>Transformasi koping maladaptif → adaptif</CardDescription></CardHeader><CardContent>{!progress.guideDone && !progress.assignmentDone && (<div className="mb-4 p-3 rounded border border-amber-300 bg-amber-50 text-amber-900 text-sm">Penugasan terkunci. Selesaikan Panduan Penugasan untuk membuka.</div>)}<div className={(!progress.guideDone && !progress.assignmentDone)?'pointer-events-none opacity-60 select-none':''}>
                  <div className="space-y-8">
                    <div>
                      <h4 className="font-semibold mb-3">Identitas Peserta</h4>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                        <div><label className="block text-xs font-medium mb-1">Nama</label><input className="w-full border rounded p-2 text-sm bg-gray-50" value={user?.full_name || '-'} disabled /></div>
                        <div><label className="block text-xs font-medium mb-1">Hari</label><input className="w-full border rounded p-2 text-sm bg-gray-50" value={new Date().toLocaleDateString('id-ID',{ weekday:'long'})} disabled /></div>
                        <div><label className="block text-xs font-medium mb-1">Tanggal</label><input className="w-full border rounded p-2 text-sm bg-gray-50" value={new Date().toLocaleDateString('id-ID')} disabled /></div>
                      </div>
                    </div>
                    ...
                    <div><h4 className="font-semibold mb-3">2. Koping Maladaptif (Buruk)</h4><textarea rows={3} className="w-full rounded border p-2 text-sm" value={assignment.kopingMaladaptif} onChange={e=> setAssignment(p=> ({ ...p, kopingMaladaptif: e.target.value }))} disabled={progress.assignmentDone} /></div>
                    <div><h4 className="font-semibold mb-3">3. Perencanaan Aktivitas</h4><textarea rows={3} className="w-full rounded border p-2 text-sm" value={assignment.perencanaanAktivitas} onChange={e=> setAssignment(p=> ({ ...p, perencanaanAktivitas: e.target.value }))} disabled={progress.assignmentDone} /></div>
                    <div><h4 className="font-semibold mb-3">4. Tindakan</h4><textarea rows={3} className="w-full rounded border p-2 text-sm" value={assignment.tindakan} onChange={e=> setAssignment(p=> ({ ...p, tindakan: e.target.value }))} disabled={progress.assignmentDone} /></div>
                    <div><h4 className="font-semibold mb-3">5. Hasil</h4><textarea rows={3} className="w-full rounded border p-2 text-sm" value={assignment.hasil} onChange={e=> setAssignment(p=> ({ ...p, hasil: e.target.value }))} disabled={progress.assignmentDone} /></div>
                    <div><h4 className="font-semibold mb-3">6. Refleksi</h4><textarea rows={3} className="w-full rounded border p-2 text-sm" value={assignment.refleksi} onChange={e=> setAssignment(p=> ({ ...p, refleksi: e.target.value }))} disabled={progress.assignmentDone} /></div>
                    <div><h4 className="font-semibold mb-3">7. Jurnal Harian</h4><textarea rows={5} className="w-full rounded border p-2 text-sm" value={assignment.jurnal} onChange={e=> setAssignment(p=> ({ ...p, jurnal: e.target.value }))} disabled={progress.assignmentDone} /></div>
...
export default SpiritualPsikoedukasiPortalSesi3;
