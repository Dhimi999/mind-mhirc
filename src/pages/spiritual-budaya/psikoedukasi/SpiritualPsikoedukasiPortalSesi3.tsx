      ...
      <main className="flex-1 pt-24">
        <section className="relative overflow-hidden rounded">
          ...
          <div className="relative container mx-auto px-6 py-14"><div className="max-w-5xl mx-auto">
            ...
            <p className="text-indigo-100 max-w-2xl">Transformasi koping maladaptif menjadi strategi adaptif & konstruktif.</p>
          </div></div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              <div className="lg:col-span-1 space-y-6">
                <div className="rounded-xl bg-gradient-to-b from-indigo-50 to-white border border-indigo-100 p-5 shadow-sm sticky top-28">
                  ...
                  <div className="mb-4"><div className="h-3 w-full bg-indigo-100 rounded-full overflow-hidden"><div className="h-full bg-gradient-to-r from-indigo-600 to-violet-600 rounded-full transition-all" style={{ width: `${overallPercent}%` }} /></div><div className="mt-2 text-xs text-indigo-700 font-medium">{overallPercent}% selesai</div></div>
                  <ol className="space-y-3 text-xs">
                    <li className="flex items-center gap-2"><span className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-semibold ${progress.sessionOpened?'bg-green-500 text-white':'bg-indigo-200 text-indigo-800'}`}>âœ“</span><span>Sesi Dibuka</span></li>
                    <li className="flex items-center gap-2"><span className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-semibold ${progress.meetingDone?'bg-green-500 text-white':'bg-indigo-200 text-indigo-800'}`}>1</span><span>Pertemuan Daring</span></li>
                    <li className="flex items-center gap-2"><span className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-semibold ${(progress.meetingDone && hasReadGuide)||progress.assignmentDone?'bg-green-500 text-white':'bg-indigo-200 text-indigo-800'}`}>2</span><span>Panduan & Penugasan</span></li>
                ...
                <div className="rounded-xl border border-indigo-100 p-4 text-xs leading-relaxed bg-white/60 backdrop-blur"><p className="font-semibold mb-1 text-indigo-700">Tips</p><p>Gunakan aktivitas bermakna (olahraga ringan, journaling) sebagai koping adaptif.</p></div>
              </div>
