          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center mb-12 fade-in">
              ...
              <p className="text-base md:text-lg text-muted-foreground">
                Pusat Riset Inovatif Kesehatan Mental yang didedikasikan untuk
                mengembangkan solusi kesehatan mental yang berbasis bukti, peka
                budaya, dan terjangkau untuk masyarakat Indonesia.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto text-center mb-16 fade-in">
              ...
              <p className="text-muted-foreground">
                Kesehatan mental yang baik sama pentingnya dengan kesehatan
                fisik. Kondisi mental yang sehat memungkinkan kita untuk
                mengembangkan potensi diri, mengatasi stres kehidupan, dan
                ...
                <div className="p-8 relative z-10">
                  ...
                  <div className="mt-8 flex items-center text-primary font-medium">
                    <span className="text-sm">
                      48% penderita gangguan mental mengalami penurunan fungsi
                      kognitif
                    </span>
                  </div>
                </div>
              ...
              <div className="rounded-2xl overflow-hidden shadow-medium transition-all duration-300 hover:shadow-highlight bg-white/90 backdrop-blur-sm relative h-full group">
                ...
                <div className="p-8 relative z-10">
                  ...
                  <div className="mt-8 flex items-center text-secondary font-medium">
                    <span className="text-sm">
                      67% pasien dengan gangguan mental kronis memiliki masalah
                      kesehatan fisik
                    </span>
                  </div>
                </div>
              ...
              <div className="rounded-2xl overflow-hidden shadow-medium transition-all duration-300 hover:shadow-highlight bg-white/90 backdrop-blur-sm relative h-full group">
                ...
                <div className="p-8 relative z-10">
                  ...
                  <div className="mt-8 flex items-center text-accent-600 font-medium">
                    <span className="text-sm">
                      85% orang melaporkan peningkatan kualitas hidup setelah
                      terapi
                    </span>
                  </div>
                </div>
          ...
          <div className="container mx-auto max-w-6xl relative z-10">
            <div className="text-center mb-10 fade-in">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Logo kami merepresentasikan visi dan misi Mind MHIRC sebagai
                pusat riset inovatif kesehatan mental yang menghubungkan ilmu
                pengetahuan dengan solusi praktis.
              </p>
            </div>
              ...
              <div className="space-y-4 order-1 lg:order-2">
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="lamp">
                    ...
                    <AccordionContent>
                      <p className="text-muted-foreground pl-[52px]">
                        Melambangkan pencerahan, inovasi, dan solusi baru dalam
                        kesehatan mental. Cahaya yang menerangi jalan untuk
                        pemahaman yang lebih baik tentang kesehatan mental.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="network">
                    ...
                    <AccordionContent>
                      <p className="text-muted-foreground pl-[52px]">
                        Garis-garis yang menghubungkan melambangkan integrasi
                        ilmu pengetahuan, teknologi, dan praktik klinis. Juga
                        mewakili kolaborasi antara berbagai pemangku kepentingan
                        dalam ekosistem kesehatan mental.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="connection">
                    ...
                    <AccordionContent>
                      <p className="text-muted-foreground pl-[52px]">
                        Lingkaran oranye di setiap ujung melambangkan berbagai
                        aspek kesehatan mental yang kami teliti dan kembangkan,
                        serta menggambarkan pendekatan holistik kami terhadap
                        kesehatan mental.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              <div className="mb-12 text-center fade-in">
                ...
                <p className="text-muted-foreground">
                  Menghubungkan penelitian ilmiah, teknologi, dan pemahaman
                  budaya lokal untuk menciptakan solusi kesehatan mental yang
                ...
                <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 mb-6">
                  {tabs.map((tab) => (
                    <button
                      key={tab.id}
                      onClick={() =>
                        setActiveTab(tab.id as "visi" | "misi" | "nilai")
                      }
                  ...
                  {activeTab === "visi" && (
                    <div className="fade-in">
                      ...
                      <p className="mb-4 text-muted-foreground">
                        Menjadi pusat unggulan dalam pengembangan dan
                        implementasi solusi kesehatan mental inovatif yang
                        berbasis bukti dan peka budaya untuk meningkatkan
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <div className="bg-white p-4 rounded-lg shadow-soft flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              Menghasilkan penelitian berkualitas tinggi yang
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-soft flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              Layanan kesehatan mental yang dapat diakses oleh
                    ...
                    <div className="fade-in">
                      ...
                      <ul className="space-y-4 mb-4">
                        <li className="flex items-start">
                          ...
                          <p className="text-muted-foreground">
                            Melakukan penelitian berkualitas tinggi untuk
                            mengembangkan solusi kesehatan mental yang efektif
                            dan peka budaya.
                          </p>
                        </li>
                        ...
                        <li className="flex items-start">
                          ...
                          <p className="text-muted-foreground">
                            Mengembangkan teknologi dan inovasi untuk
                        ...
                        <li className="flex items-start">
                          ...
                          <p className="text-muted-foreground">
                            Menjalin kemitraan strategis dengan berbagai
                            pemangku kepentingan untuk memperluas jangkauan
                        ...
                        <li className="flex items-start">
                          ...
                          <p className="text-muted-foreground">
                            ...
                            kesehatan mental melalui edukasi dan advokasi.
                          </p>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="fade-in">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                        <div className="bg-white p-4 rounded-lg shadow-soft">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Menjunjung tinggi prinsip-prinsip etika dalam semua
                            aspek penelitian dan layanan.
                          </p>
                        </div>
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-soft">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Terus mengembangkan pendekatan dan solusi baru yang
                            efektif.
                          </p>
                        </div>
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-soft">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Bekerja sama dengan berbagai pihak untuk mencapai
                            tujuan bersama.
                          </p>
                        </div>
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-soft">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Menghargai keberagaman dan memastikan akses yang
                            setara bagi semua.
                          </p>
                        </div>
                      </div>
        ...
        <section className="py-16 px-4 sm:px-6 bg-background">
          <div className="container mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-12 fade-in">
              ...
              <p className="text-muted-foreground">
                Tim multidisiplin kami terdiri dari psikolog, peneliti,
                pengembang teknologi, dan pendidik yang berdedikasi untuk
                menciptakan solusi kesehatan mental terbaik.
              </p>
            </div>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12 fade-in">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                ...
                dengan kami? Jangan ragu untuk menghubungi kami melalui formulir
                di bawah ini.
              </p>
            </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium mt-1">
                          Jl. Kesehatan Mental No. 45, Jakarta Selatan 12345,
                          Indonesia
                        </p>
                      </div>
                    </div>
