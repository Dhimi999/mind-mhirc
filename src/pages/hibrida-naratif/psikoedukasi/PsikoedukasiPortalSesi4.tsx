...
const ASSIGNMENT_KEY = "psikoEduSession4Assignment";
...
const PsikoedukasiPortalSesi4: React.FC = () => {
  ...
  const renderGuide = () => { if (!progress.meetingDone) return <div className="text-sm text-muted-foreground">Panduan akan muncul setelah Anda menandai Pertemuan Daring selesai.</div>; return (
    <div className="space-y-4 text-sm leading-relaxed">
      <div className="rounded-lg border-l-4 border-indigo-600 bg-gradient-to-r from-indigo-50 to-white p-4">
        <p className="font-semibold text-indigo-800 mb-1">Fokus Sesi 4 — Perilaku Mencari Bantuan</p>
      ...
      <div className="border rounded p-3 bg-indigo-50 text-xs text-indigo-800">Catatan: Normal untuk merasa ragu mencari bantuan — latihan ini membantu membangun keberanian & struktur langkah.</div>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        ...
        <link rel="canonical" href="https://mind-mhirc.my.id/hibrida-cbt/psikoedukasi/sesi/4" />
      </Helmet>
      <Navbar />
...
export default PsikoedukasiPortalSesi4;
