...
const PsikoedukasiPortalSesi3: React.FC = () => {
    ...
    return (
      <div className="space-y-4 text-sm leading-relaxed">
        <div className="rounded-lg border-l-4 border-indigo-600 bg-gradient-to-r from-indigo-50 to-white p-4">
          <p className="font-semibold text-indigo-800 mb-1">Fokus Sesi 3 — Koping Adaptif</p>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet><title>Sesi 3 - {title} | Psikoedukasi</title><meta name="description" content={`Portal psikoedukasi sesi 3: ${title}`} /><link rel="canonical" href="https://mind-mhirc.my.id/hibrida-cbt/psikoedukasi/sesi/3" /></Helmet>
      <Navbar />
              ...
              <div className="lg:col-span-1 space-y-6">
                <div className="rounded-xl bg-gradient-to-b from-indigo-50 to-white border border-indigo-100 p-5 shadow-sm sticky top-28">
                  ...
                  <ol className="space-y-3 text-xs">
                    <li className="flex items-center gap-2"><span className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-semibold ${progress.sessionOpened?'bg-green-500 text-white':'bg-indigo-200 text-indigo-800'}`}>✓</span><span>Sesi Dibuka</span></li>
...
export default PsikoedukasiPortalSesi3;
