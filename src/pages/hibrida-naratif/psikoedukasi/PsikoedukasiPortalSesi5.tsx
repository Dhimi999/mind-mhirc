...
const ASSIGNMENT_KEY = "psikoEduSession5Assignment";
...
const PsikoedukasiPortalSesi5: React.FC = () => {
  ...
  const renderGuide = () => { if (!progress.meetingDone) return <div className="text-sm text-muted-foreground">Panduan akan muncul setelah Anda menandai Pertemuan Daring selesai.</div>; return (
    <div className="space-y-4 text-sm leading-relaxed">
      <div className="rounded-lg border-l-4 border-indigo-600 bg-gradient-to-r from-indigo-50 to-white p-4">
        <p className="font-semibold text-indigo-800 mb-1">Fokus Sesi 5 — Pengurangan Stigma</p>
  ...
  <li>Tuliskan 2–3 langkah konkret untuk mengurangi stigma di lingkungan Anda.</li>
      </ul>
  <div className="border rounded p-3 bg-indigo-50 text-xs text-indigo-800">Catatan: Gunakan bahasa inklusif dan empatik — ini langkah sederhana namun efektif untuk menurunkan stigma.</div>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        ...
        <link rel="canonical" href="https://mind-mhirc.my.id/hibrida-cbt/psikoedukasi/sesi/5" />
      </Helmet>
      <Navbar />
        ...
        <section className="relative overflow-hidden rounded">
          ...
          <div className="relative container mx-auto px-6 py-14">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-indigo-100 max-w-3xl">Pengurangan stigma adalah sesi untuk mengurangi stigma terkait kesehatan mental dan bunuh diri. Melalui diskusi dan edukasi, mahasiswa diharapkan lebih terbuka dalam berbicara tentang kesehatan mental dan tidak merasa malu untuk mencari bantuan.</p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              <div className="lg:col-span-1 space-y-6">
                ...
                <div className="rounded-xl border border-indigo-100 p-4 text-xs leading-relaxed bg-white/60 backdrop-blur"><p className="font-semibold mb-1 text-indigo-700">Tips</p><p>Gunakan bahasa yang netral dan empatik saat membahas isu sensitif.</p></div>
              </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            {(['A','B','C'] as const).map(k => (
                              <div key={k} className="rounded border p-3 bg-muted/30">
                                <div className="flex items-center justify-between mb-1"><span className="text-xs text-muted-foreground">Grup</span><span className="px-2 py-0.5 text-[11px] rounded-full bg-indigo-100 text-indigo-800 border border-indigo-200">{k}</span></div>
...
export default PsikoedukasiPortalSesi5;
