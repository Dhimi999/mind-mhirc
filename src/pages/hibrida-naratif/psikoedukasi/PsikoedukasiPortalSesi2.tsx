...
const ASSIGNMENT_KEY = "psikoEduSession2Assignment";
...
const PsikoedukasiPortalSesi2: React.FC = () => {
  const sessionNumber = 2;
  const title = "Mengenali Tanda-Tanda Dini Risiko Bunuh Diri Bagi Mahasiswa";
  const { user } = useAuth();

  const { progress, meetingSchedule: schedule, markMeetingDone, submitAssignment, loadAssignment, autoSaveAssignment, groupAssignment, isSuperAdmin, allGroupSchedules, loading } = usePsikoedukasiSession(sessionNumber, user?.id);
    ...
    return (
      <div className="space-y-4 text-sm leading-relaxed">
        <div className="rounded-lg border-l-4 border-indigo-600 bg-gradient-to-r from-indigo-50 to-white p-4">
          <p className="font-semibold text-indigo-800 mb-1">Fokus Sesi 2 — Mengenali Tanda-Tanda Dini Risiko Bunuh Diri</p>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        ...
        <link rel="canonical" href="https://mind-mhirc.my.id/hibrida-cbt/psikoedukasi/sesi/2" />
      </Helmet>
      <Navbar />
...
export default PsikoedukasiPortalSesi2;
