        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center space-x-2 bg-purple-100 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-purple-700 font-medium text-sm">Forum & Konsultasi</span>
            </div>
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <button className="bg-pink-600 hover:bg-pink-700 text-white px-6 py-2 rounded-full text-sm font-medium transition-colors flex items-center space-x-2">
          ...
          <div className="bg-white rounded-2xl shadow-soft p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Pilih Layanan</h3>
                <p className="text-sm text-gray-600">
                  Pilih jenis dukungan yang Anda butuhkan dari berbagai opsi yang tersedia.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Daftar atau masuk ke forum/jadwalkan konsultasi sesuai kebutuhan Anda.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Dapatkan Dukungan</h3>
                <p className="text-sm text-gray-600">
          ...
          <div className="bg-gradient-to-r from-pink-500 to-purple-600 rounded-2xl p-8 text-center text-white">
            ...
            <p className="mb-6 opacity-90">
              Bergabunglah dengan ribuan ibu lainnya yang telah merasakan manfaat 
              dukungan komunitas dan konsultasi profesional kami.
            </p>
